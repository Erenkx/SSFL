"""
Masked Autoencoder with VisionTransformer backbone for pretraining.
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def random_masking(self, x, mask_ratio):
        ...
        Args:
            x: [N, L, D], sequence.
            mask_ratio (float): Ratio of removed patches.
        """
        ...
        ids_shuffle = torch.argsort(noise, dim=1) # keep small, remove large
